...
This appendix records the public evidence, measurement definitions, and release boundary used by the current SAT-Edge-Agent manuscript. The public release is available at \url{https://github.com/keithhegit/SAT-Edge-Agent}; all paths below are relative to that repository root.
